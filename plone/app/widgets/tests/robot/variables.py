...
SELENIUM_TIMEOUT = os.environ.get('SELENIUM_IMPLICIT_WAIT', '5s')
...
TEST_FOLDER = os.environ.get('TEST_FOLDER', "%s" % PLONE_URL)

PATH_TO_TEST_FILES = resource_filename("plone.app.widgets.tests", "")
